...
namespace HMEye.Template.DumbAuth.Migrations
{
	/// <inheritdoc />
	public partial class InitialDumbAuth : Migration
	{
		/// <inheritdoc />
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					ExpireTimeSpanMinutes = table.Column<int>(type: "INTEGER", nullable: false),
